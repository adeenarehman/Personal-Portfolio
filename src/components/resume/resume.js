                ...
                <Box sx={{ width: '100%', mt: 3 }}>
                  ...
                  <Card sx={{ backgroundColor: '#111418', width: '100%', mt: 3, p: 1, borderRadius: 1.5 }}> {/* SJJ Card */}
                    <CardContent>
                      ...
                      <Typography my={2} variant='body1' fontWight='bold' color='#fff'>
                        •	 Managed and developed a web panel and website using React Js. 
                        Developed backend solutions using Node.js and MySQL to ensure robust and efficient data management.
                      </Typography>
                      <Typography my={2} variant='body1' fontWight='bold' color='#fff'>
                        •	 Developed backend solutions using Node.js and MySQL to ensure robust and efficient data management.
                      </Typography>
                  ...
                  <Card sx={{ backgroundColor: '#111418', width: '100%', mt: 3, p: 1, borderRadius: 1.5 }}> {/* SJJ Card */}
                    <CardContent>
                      ...
                      <Typography my={2} variant='body1' fontWight='bold' color='#fff'>
                        •	Presented and Executed multiple freelance projects including
                        website and admin dashboard development.
                      </Typography>
                      <Typography my={2} variant='body1' fontWight='bold' color='#fff'>
                        •	Leveraged front-end technologies such as React and utilized back-end
              ...
              <Grid item xs={12} sm={12} md={12} lg={5} display={'flex'} flexDirection={'column'} alignItems={'center'}>
                <Box sx={{ width: '100%' }}>
                  <Slide direction={"up"}>
                    <Box mt={3} width={'100%'}>
                      <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                        <Typography variant={'body1'} fontWeight={'bold'} color={'#fff'} >HTML/CSS</Typography>
                        <Typography variant={'body1'} fontWeight={'bold'} color={'#fff'} >90%</Typography>
                      </Box>
                  ...
                  <Slide direction={"up"} delay={1e2}>
                    <Box mt={3} width={'100%'}>
                      <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                        <Typography variant={'body1'} fontWeight={'bold'} color={'#fff'}>React</Typography>
                        <Typography variant={'body1'} fontWeight={'bold'} color={'#fff'}>90%</Typography>
                      </Box>
                        <LinearProgress variant="determinate" color="error" value={90} />
                    </Box>
                  ...
                  <Slide direction={"up"} delay={1e2}>
                    <Box mt={3} width={'100%'}>
                      <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                        <Typography variant={'body1'} fontWeight={'bold'} color={'#fff'}>React Redux</Typography>
              ...
              <Grid item xs={12} sm={12} md={12} lg={5} display={'flex'} flexDirection={'column'} alignItems={'center'}>
                <Box sx={{ width: '100%', }}>
                  ...
                  <Slide direction={"up"} delay={1e2}>
                    <Box mt={3} width={'100%'}>
                      <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
                        <Typography variant={'body1'} fontWeight={'bold'} color={'#fff'}>MySQL</Typography>
                        <Typography variant={'body1'} fontWeight={'bold'} color={'#fff'}>60%</Typography>
                      </Box>
